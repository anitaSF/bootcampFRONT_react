...
function ListProduct({ listProduct }) {
    ...
    // Este nuevo array se aloja en la variable creada "dataLi" que será la utilizada como contenido del elemento html definido en el return donde se pintará la lista de productos
